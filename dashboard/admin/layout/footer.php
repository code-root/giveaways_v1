...
<footer class="footer pt-3  ">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-end">
                ...
                <a href="<?=URL?>" class="font-weight-bold" target="_blank"><?=NameSite?></a>
               Development <a href="http://smartagent-com.com/"> Smart Agent</a>  <i class="fa fa-heart"></i>
              </div>
            </div>
            ...
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="<?=URL?>" class="nav-link text-muted" target="_blank">الصفحة الرئيسية</a>
                </li>
                <li class="nav-item">
                  <a href="<?=URL?>/about-me.php" class="nav-link text-muted" target="_blank">من نحن</a>
                </li>
                <li class="nav-item">
                  <a href="<?=URL?>/services.php" class="nav-link text-muted" target="_blank">خدماتي</a>
                </li>
                <li class="nav-item">
                  <a href="<?=URL?>/portfolio" class="nav-link pe-0 text-muted" target="_blank">معرض الأعمال</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <script src="<?=admin_assets()?>js/plugins/choices.min.js"></script>
  <script>
  ...
  <script src="<?=admin_assets()?>js/soft-ui-dashboard.min.js?v=1.0.3"></script>
</body>

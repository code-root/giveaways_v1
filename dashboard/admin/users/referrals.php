                ...
                <table id="table_id" class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">الأحالة من </th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">إالى  </th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">النقاط المكتسبة </th>
                      <th class="text-secondary opacity-7"></th>
                    </tr>
                  </thead>
                  <tbody>
               <?php
                        $sql = "SELECT * FROM referrals where status = 1 " ;
                    ...
                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?=$row['id']?></span></td>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <a href="settings.php?code=<?=$row['UserId']?>"> <h6 class="mb-0 text-sm"><?=NameUser($row['UserId'])?></h6> </a>  
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                          <a href="settings.php?code=<?=$row['referralsID']?>"> <h6 class="mb-0 text-sm"><?=NameUser($row['referralsID'])?></h6> </a>  
                          </div>
                        </div>
                      </td>
                      <td>
